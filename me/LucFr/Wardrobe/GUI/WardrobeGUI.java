...
// Create GUI
	...
	public static void CreateWardrobePage1(Player p) {
		String Name = ChatColor.translateAlternateColorCodes('&', Wardrobe.ConfigData.getConfig().getString("Title")) + " (1/2)";
	...
	public static void CreateWardrobePage2(Player p) {
		String Name = ChatColor.translateAlternateColorCodes('&', Wardrobe.ConfigData.getConfig().getString("Title")) + " (2/2)";
...
// Create Base background
	...
	public static void CreateBaseBackground(Inventory inv) {
		if (inv == Page1) {
			...
			for (int i = 0; i <= 44; i++) {
				if (i >= 0 && i <= 8) {
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Helmet-Slot.Name").replace("%Slot%", Integer.toString(i+1));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Helmet-Slot.Lore")) {
						if (i+1 == 1)
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Chestplate-Slot.Name").replace("%Slot%", Integer.toString(i-8));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Chestplate-Slot.Lore")) {
						if (i-8 == 1)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-1.Require-Prefix"));
						if (i-8 == 2)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-2.Require-Prefix"));
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Leggings-Slot.Name").replace("%Slot%", Integer.toString(i-17));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Leggings-Slot.Lore")) {
						if (i-17 == 1)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-1.Require-Prefix"));
						if (i-17 == 2)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-2.Require-Prefix"));
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Boots-Slot.Name").replace("%Slot%", Integer.toString(i-26));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Boots-Slot.Lore")) {
						if (i-26 == 1)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-1.Require-Prefix"));
						if (i-26 == 2)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-2.Require-Prefix"));
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Locked-Button.Name").replace("%Slot%", Integer.toString(i-35));
					ButtonMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> ButtonLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Locked-Button.Lore")) {
						if (i-35 == 1)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-1.Require-Prefix"));
						if (i-35 == 2)
							Lore = Lore.replace("%Permission_Require_Prefix%", Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-2.Require-Prefix"));
			...
			for (int i = 0; i <= 44; i++) {
				if (i >= 0 && i <= 8) {
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Helmet-Slot.Name").replace("%Slot%", Integer.toString(i+10));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Helmet-Slot.Lore")) {
						if (i+10 == 10)
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Chestplate-Slot.Name").replace("%Slot%", Integer.toString(i+1));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Chestplate-Slot.Lore")) {
						if (i+1 == 10)
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Leggings-Slot.Name").replace("%Slot%", Integer.toString(i-8));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Leggings-Slot.Lore")) {
						if (i-8 == 10)
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Boots-Slot.Name").replace("%Slot%", Integer.toString(i-17));
					BackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> BackgroundLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Boots-Slot.Lore")) {
						if (i-17 == 10)
					...
					String Name = Wardrobe.ConfigData.getConfig().getString("Locked-Slot.Locked-Button.Name").replace("%Slot%", Integer.toString(i-26));
					ButtonMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
					List<String> ButtonLore = new ArrayList<String>();
					for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Locked-Slot.Locked-Button.Lore")) {
						if (i-26 == 10)
...
// Create available slot
		...
		if (Name.equals(WardrobeGUI.Page1Name)) {
			for (int i = 0; i <= 8; i++) {
				if (p.hasPermission(Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-" + Integer.toString(i+1) + ".Permission"))) {
					int CheckAmount = 0;
					if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Helmet") == null) {
						inv.setItem(i, Background(i, Page1, Name));
						CheckAmount++;
					} else {
						inv.setItem(i, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Helmet"));
					}
					if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Chestplate") == null) {
						inv.setItem(i+9, Background(i+9, Page1, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+9, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Chestplate"));
					}
					if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Leggings") == null) {
						inv.setItem(i+18, Background(i+18, Page1, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+18, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Leggings"));
					}
					if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Boots") == null) {
						inv.setItem(i+27, Background(i+27, Page1, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+27, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Boots"));
					}
					if (CheckAmount == 4) {
						inv.setItem(i+36, CreateEmptyButton(i, Page1, Name));
					}
					if (Wardrobe.Page_1.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Button") != null && Wardrobe.Page_1.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Button").contains("Ready")) {
						inv.setItem(i+36, CreateReadyButton(i, Page1, Name));
					} else if (Wardrobe.Page_1.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Button") != null && Wardrobe.Page_1.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Button").contains("Equipped")) {
						inv.setItem(i+36, CreateEquippedButton(i, Page1, Name));
					}
				} else {
					for (int j = i+11; j <= 18; j++) {
						if (p.hasPermission(Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-" + (j) + ".Permission"))) {
							int CheckAmount = 0;
							for (int x = i; x <= 8; x++) {
								if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Helmet") == null) {
									inv.setItem(x, Background(x, Page1, Name));
									CheckAmount++;
								} else {
									inv.setItem(x, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Helmet"));
								}
								if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Chestplate") == null) {
									inv.setItem(x+9, Background(x+9, Page1, Name));
									CheckAmount++;
								} else {
									inv.setItem(x+9, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Chestplate"));
								}
								if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Leggings") == null) {
									inv.setItem(x+18, Background(x+18, Page1, Name));
									CheckAmount++;
								} else {
									inv.setItem(x+18, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Leggings"));
								}
								if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Boots") == null) {
									inv.setItem(x+27, Background(x+27, Page1, Name));
									CheckAmount++;
								} else {
									inv.setItem(x+27, Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (x+1) + ".Boots"));
								}
								if (CheckAmount == 4) {
									inv.setItem(i+36, CreateEmptyButton(i, Page1, Name));
								}
					...
					for (int j = i+1; j <= 9; j++) { 
						if (p.hasPermission(Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-" + Integer.toString(j) + ".Permission"))) {
							int CheckAmount = 0;
							if (Wardrobe.Page_1.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+1) + ".Helmet") == null) {
								inv.setItem(i, Background(i, Page1, Name));
								CheckAmount++;
			...
			for (int i = 0; i <= 8; i++) {
				if (p.hasPermission(Wardrobe.ConfigData.getConfig().getString("Slot-Permission.Slot-" + (i+10) + ".Permission"))) {
					int CheckAmount = 0;
					if (Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Helmet") == null) {
						inv.setItem(i, Background(i, Page2, Name));
						CheckAmount++;
					} else {
						inv.setItem(i, Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Helmet"));
					}
					if (Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Chestplate") == null) {
						inv.setItem(i+9, Background(i+9, Page2, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+9, Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Chestplate"));
					}
					if (Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Leggings") == null) {
						inv.setItem(i+18, Background(i+18, Page2, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+18, Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Leggings"));
					}
					if (Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Boots") == null) {
						inv.setItem(i+27, Background(i+27, Page2, Name));
						CheckAmount++;
					} else {
						inv.setItem(i+27, Wardrobe.Page_2.getConfig().getItemStack(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Boots"));
					}
					if (CheckAmount == 4) {
						inv.setItem(i+36, CreateEmptyButton(i, Page2, Name));
					}
					if (Wardrobe.Page_2.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Button") != null && Wardrobe.Page_2.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Button").contains("Ready")) {
						inv.setItem(i+36, CreateReadyButton(i, Page2, Name));
					} else if (Wardrobe.Page_2.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Button") != null && Wardrobe.Page_2.getConfig().getString(p.getUniqueId().toString() + ".Slot-" + (i+10) + ".Button").contains("Equipped")) {
	...
	public static ItemStack Background(int Slot, Inventory inv, String Title) {
		...
		if (Slot >= 0 && Slot <= 8) {
			...
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Helmet-Slot.Lore")) {
			...
			AvailableBackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Chestplate-Slot.Lore")) {
				AvailableBackgroundLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
			}
			...
			if (Title.equals(WardrobeGUI.Page1Name)) {
				...
				Name = Wardrobe.ConfigData.getConfig().getString("Availabel-Slot.Helmet-Slot.Name").replace("%Slot%", Integer.toString(Slot-8));
			}
			AvailableBackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Leggings-Slot.Lore")) {
				AvailableBackgroundLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
			}
			...
			if (Title.equals(WardrobeGUI.Page1Name)) {
				...
				Name = Wardrobe.ConfigData.getConfig().getString("Availabel-Slot.Helmet-Slot.Name").replace("%Slot%", Integer.toString(Slot-17));
			}
			AvailableBackgroundMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Boots-Slot.Lore")) {
				AvailableBackgroundLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
			}
		}
	...
	public static ItemStack CreateEmptyButton(int Slot, Inventory inv, String Title) {
		...
		ButtonMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
		List<String> ButtonLore = new ArrayList<String>();
		for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Empty-Slot-Button.Lore")) {
			ButtonLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
		}
		ButtonMeta.setLore(ButtonLore);
		Button.setItemMeta(ButtonMeta);
	...
	public static ItemStack CreateReadyButton(int Slot, Inventory inv, String Title) {
		...
		ButtonMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
		List<String> ButtonLore = new ArrayList<String>();
		for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Ready-Button.Lore")) {
			ButtonLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
		}
		ButtonMeta.setLore(ButtonLore);
		Button.setItemMeta(ButtonMeta);
	...
	public static ItemStack CreateEquippedButton(int Slot, Inventory inv, String Title) {
		...
		ButtonMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Name));
		List<String> ButtonLore = new ArrayList<String>();
		for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Availabel-Slot.Equipped-Button.Lore")) {
			ButtonLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
		}
		ButtonMeta.setLore(ButtonLore);
		Button.setItemMeta(ButtonMeta);
...
// Create Button
	public static void CreateGoBackAndCloseButton(Inventory inv) {
		...
		if (Wardrobe.ConfigData.getConfig().getBoolean("Go-Back-Button.Enable")) {
			...
			GoBackMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Wardrobe.ConfigData.getConfig().getString("Go-Back-Button.Name")));
			List<String> GoBackLore = new ArrayList<String>();
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Go-Back-Button.Lore")) {
				GoBackLore.add(ChatColor.translateAlternateColorCodes('&', Lore));
			}
			GoBackMeta.setLore(GoBackLore);
			GoBack.setItemMeta(GoBackMeta);
			inv.setItem(Wardrobe.ConfigData.getConfig().getInt("Go-Back-Button.Slot"), GoBack);
		}
	// Close button
		if (Wardrobe.ConfigData.getConfig().getBoolean("Close-Button.Enable")) {
			...
			for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Close-Button.Lore")) {
	...
	public static void CreateNextAndPreviousButton(Inventory inv) {
		if (inv == Page1) {
			if (Wardrobe.ConfigData.getConfig().getBoolean("Next-Page-Button.Enable")) {
				...
				for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Next-Page-Button.Lore")) {
			...
			if (Wardrobe.ConfigData.getConfig().getBoolean("Previous-Page-Button.Enable")) {
				...
				for (String Lore : Wardrobe.ConfigData.getConfig().getStringList("Previous-Page-Button.Lore")) {
