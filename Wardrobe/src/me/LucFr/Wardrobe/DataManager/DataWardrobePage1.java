...
public class DataWardrobePage1 {
	
	private Main plugin;
	private FileConfiguration dataConfig = null;
	private File configFile = null;
	
	public DataWardrobePage1(Main plugin) {
		this.plugin = plugin;
		saveDefaultConfig();
	}
	...
	public void ReloadConfig() {
		if (this.configFile == null)
			this.configFile = new File(this.plugin.getDataFolder(), "Wardrobe Data Page 1.yml");
		
		
		this.dataConfig = YamlConfiguration.loadConfiguration(this.configFile);
		
		InputStream defaultStream = this.plugin.getResource("Wardrobe Data Page 1.yml");
	...
	public void saveDefaultConfig() {
		...
		if (!this.configFile.exists()) {
			this.plugin.saveResource("Wardrobe Data Page 1.yml", false);
		}
	}
